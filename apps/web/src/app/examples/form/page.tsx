...
const exampleSchema = z.object({
  ...
  age: z.coerce.number().min(18, 'You must be at least 18 years old').max(120, 'Age must be at most 120'),
      ...
      <section className="mb-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-4">
            <Button type="submit" variant="primary" size="sm">Submit (Primary Small)</Button>
            <Button type="submit" variant="primary" size="md">Submit (Primary Medium)</Button>
            <Button type="submit" variant="primary" size="lg">Submit (Primary Large)</Button>
            <Button type="submit" variant="primary" size="xl">Submit (Primary Extra Large)</Button>
            <Button type="submit" variant="secondary" size="sm">Submit (Secondary Small)</Button>
            <Button type="submit" variant="secondary" size="md">Submit (Secondary Medium)</Button>
            <Button type="submit" variant="secondary" size="lg">Submit (Secondary Large)</Button>
            <Button type="submit" variant="secondary" size="xl">Submit (Secondary Extra Large)</Button>
          </div>
        </form>
      </section>
    </div>
